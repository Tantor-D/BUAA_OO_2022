    ...
    public void initial() {
        ...
        for (int i = 0; i < 5; i++) {
            VerticalElevator verticalElevator =
                    new VerticalElevator(verticalQueues.get(i), i, i + 1);
        ...
        while (true) {
            ...
            if (request instanceof PersonRequest) {
                ...
                if (elevatorRequest.getType().equals("building")) { // 纵向电梯
                    ...
                    VerticalElevator verticalElevator =
                            new VerticalElevator(verticalQueues.get(buildingNum),
                                    buildingNum,
                    ...
                    HorizontalElevator horizontalElevator =
                            new HorizontalElevator(horizontalQueues.get(floorNum),
                                    floorNum,
                                    elevatorRequest.getElevatorId());
