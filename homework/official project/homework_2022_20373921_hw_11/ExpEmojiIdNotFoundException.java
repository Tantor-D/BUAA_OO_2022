...
public class ExpEmojiIdNotFoundException extends EmojiIdNotFoundException {
    private static int count = 0;
    private static HashMap<Integer, Integer> idToCountMap = new HashMap<>();
    private final int id;
    
    public ExpEmojiIdNotFoundException(int id) {
        this.id = id;
        count++;
    ...
    @Override
    public void print() {
        System.out.println("einf-" + count + ", " + id + "-" + idToCountMap.get(id));
    }
}
