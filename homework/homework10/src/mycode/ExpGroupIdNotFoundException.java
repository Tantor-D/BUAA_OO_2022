...
public class ExpGroupIdNotFoundException extends GroupIdNotFoundException {
    private static int count = 0;
    private static HashMap<Integer, Integer> idToCountMap = new HashMap<>();
    private int id;
    
    public ExpGroupIdNotFoundException(int id) {
        this.id = id;
        count++;
    ...
    @Override
    public void print() {
        System.out.println("ginf-" + count + ", " + id + "-" + idToCountMap.get(id));
    }
}
