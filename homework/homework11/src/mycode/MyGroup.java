...
public class MyGroup implements Group {
    ...
    public void personSendMoney(int personId, int totalMoney) {
        int unitMoney = totalMoney / people.size();
        people.get(personId).addMoney(-1 * unitMoney * people.size());
        
        for (Person person : people.values()) {
            person.addMoney(unitMoney);
        }
    }
}
