...
int main() {
    ...
    str = "java -jar Assassin.jar < .\\input\\in1.txt > .\\zgy_output\\out1.txt";
    start_time2 = clock();
    system(str.c_str());
    end_time2 = clock();
    ...
    for (int i = 1; i <= random_test_time; i++) {
        ...
        system("java -jar java_data_generator.jar");
        ...
        str = "java -jar Caster.jar < .\\input\\in.txt > .\\zgy_output\\out.txt";
        start_time2 = clock();
        system(str.c_str());
        end_time2 = clock();
